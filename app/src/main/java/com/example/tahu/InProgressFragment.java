...
public class InProgressFragment extends Fragment {
    ...
    private List<TasksModel> inProgressTasksList;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        rvInProgress = view.findViewById(R.id.rv_inprogress);
        rvInProgress.setLayoutManager(new LinearLayoutManager(requireContext()));

        tasksRef = FirebaseDatabase.getInstance().getReference("tasks");

        inProgressTasksList = new ArrayList<>();

        taskAdapter = new TaskAdapter(requireContext(), inProgressTasksList);
        rvInProgress.setAdapter(taskAdapter);
    ...
    private void loadInProgressTasks() {
        tasksRef.orderByChild("t_status").equalTo("inprogress")
